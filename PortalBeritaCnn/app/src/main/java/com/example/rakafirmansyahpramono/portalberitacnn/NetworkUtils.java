...
public class NetworkUtils {
    ...
    private static final String Berita_BASE_URL =
     ...
     */
    static String getBeritaInfo(String queryString) {

        // Set up variables for the try block that need to be closed in the
        // finally block.
        HttpURLConnection urlConnection = null;
        BufferedReader reader = null;
        String BeritaJSONString = null;

        try {
            // Build the full query URI, limiting results to 10 items and
            // printed books.
            Uri builtURI = Uri.parse(Berita_BASE_URL).buildUpon()
                    .appendQueryParameter(QUERY_PARAM, queryString)
                    .appendQueryParameter(MAX_RESULTS, "1000000000000")
                    .appendQueryParameter(PRINT_TYPE, "news")
                    .build();
            ...
            BeritaJSONString = builder.toString();
        ...
        Log.d(LOG_TAG, BeritaJSONString);

        return BeritaJSONString;
    }
}
