 ...
 * the background.
 */
public class tampilan_API extends AppCompatActivity
        implements LoaderManager.LoaderCallbacks<String> {

    private EditText mBeritaInput;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tampilan_api);

        mBeritaInput = findViewById(R.id.BeritaInput);
     ...
     */
    public void searchBerita(View view) {
        // Get the search string from the input field.
        String queryString = mBeritaInput.getText().toString();
    ...
    public Loader<String> onCreateLoader(int id, @Nullable Bundle args) {
        ...
        return new BeritaLoader(this, queryString);
    }
    ...
    public void onLoadFinished(@NonNull Loader<String> loader, String data) {
        try {
            ...
            JSONArray itemsArray = jsonObject.getJSONArray("source");
            ...
            while (i < itemsArray.length() &&
                ...
                JSONObject Berita = itemsArray.getJSONObject(i);
                JSONObject volumeInfo = Berita.getJSONObject("volumeInfo");
